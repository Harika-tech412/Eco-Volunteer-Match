  ...
  return (
    <div className="page">
      <div className="topRow">
        ...
        <button type="button" className="pillBtn mapViewBtn" onClick={() => alert("Coming soon")}>
      ...
      <div className="stats">
        ...
        <StatCard tintClass="tintPurple" icon={<span>📅</span>} value={joinedCount} label="Events Joined" />
        <StatCard tintClass="tintPink" icon={<span>📍</span>} value={nearbyCount} label="Nearby Events" />
